...
const menuItems = {
  items: [dashboard, userManagement, instituteManagement,taxManagement,discountManagement,PaymentManagement,subscriptionManagement, helpCenter,notificationManagement]
};
