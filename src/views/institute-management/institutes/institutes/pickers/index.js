  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <PageHeader
          subtitle={<Typography sx={{ color: 'text.secondary' }}>A simple and reusable datepicker component for React</Typography>}
          title={
        ...
        <Grid item xs={12}>
          <CardSnippet title="Month & Year Dropdowns" code={{ tsx: null, jsx: source.PickersMonthYearDropdownsJSXCode }}>
