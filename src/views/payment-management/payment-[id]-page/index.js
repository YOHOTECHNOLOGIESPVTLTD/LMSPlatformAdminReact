...
const InstitutePaymentView = () => {
  ...
  const subReqColumns = [
    { field: 'newSubscriptionId', headerName: 'New Subscription ID', width: 300, headerAlign: 'center', align: 'center' },
    { field: 'reqdate', headerName: 'Requested Date', width: 300, headerAlign: 'center', align: 'center' },

    {
      ...
      renderCell: (params) => (
        <Box display="flex" gap={1}>
          <Button variant="contained" color="success" size="large" onClick={() => handleApprove(params.row.id)}>
            Approve
          </Button>
          <Button variant="contained" color="error" size="large" onClick={() => handleReject(params.row.id)}>
            Reject
          </Button>
        </Box>
      )
  ...
  const paymentColumns = [
    { field: 'paymentId', headerName: 'Payment ID', width: 200, headerAlign: 'left', align: 'left' },
    { field: 'amount', headerName: 'Amount', width: 150, headerAlign: 'left', align: 'left' },
    { field: 'paymentStatus', headerName: 'Payment Status', width: 200, headerAlign: 'left', align: 'left' },
    { field: 'paymentMethod', headerName: 'Payment Method', width: 250, headerAlign: 'left', align: 'left' },
    { field: 'paymentDate', headerName: 'Payment Date', width: 200, headerAlign: 'left', align: 'left' },
    { field: 'transactionid', headerName: 'Payment id', width: 300, headerAlign: 'left', align: 'left' },
      ...
      <Container sx={{ mt: 4 }}>
        ...
        <Box mt={4}>
          ...
          <Dialog open={openDialog} onClose={handleClose}>
            ...
            <DialogContent>Are you sure you want to proceed with this payment?</DialogContent>
            <DialogActions>
