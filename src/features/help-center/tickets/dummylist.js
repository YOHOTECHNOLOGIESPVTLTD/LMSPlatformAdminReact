...
const data = {
    users: [
      {
        id: 101,
      createdDate: `13 ${currentMonth} ${now.getFullYear()}`,
      ClosedDate:`23 ${currentMonth} ${now.getFullYear()}`,
      issue:"Email not solved",
      solution:"solved",
        billing: 'Auto Debit',
      ...
      {
        id: 201,
        createdDate: `14 ${currentMonth} ${now.getFullYear()}`,
        ClosedDate:`24 ${currentMonth} ${now.getFullYear()}`,
        issue:"Number not working",
        solution:"solved",
      ...
      {
        id: 303,
        createdDate: `15 ${currentMonth} ${now.getFullYear()}`,
        ClosedDate:`25 ${currentMonth} ${now.getFullYear()}`,
        issue:"Number not working",
        solution:"solved",
        billing: 'Manual - Cash',
      ...
      {
        id: 405,
        createdDate: `16 ${currentMonth} ${now.getFullYear()}`,
        ClosedDate:`26 ${currentMonth} ${now.getFullYear()}`,
      ...
      {
        id: 501,
        createdDate: `17 ${currentMonth} ${now.getFullYear()}`,
        ClosedDate:`27 ${currentMonth} ${now.getFullYear()}`,
        issue:"Number not working",
        solution:"Not solved",
        billing: 'Auto Debit',
      ...
      {
        id: 666,
        createdDate: `19 ${currentMonth} ${now.getFullYear()}`,
        ClosedDate:`29 ${currentMonth} ${now.getFullYear()}`,
        issue:"Number not working",
        solution:"solved",
        billing: 'Manual - Cash',
      ...
      {
        id: 700,
        createdDate: `1 ${currentMonth} ${now.getFullYear()}`,
        ClosedDate:`10 ${currentMonth} ${now.getFullYear()}`,
        issue:"Number not working",
        solution:"solved",
        billing: 'Manual - Paypal',
      ...
      {
        id: 87867,
        createdDate: `24 ${currentMonth} ${now.getFullYear()}`,
        ClosedDate:`14 ${currentMonth} ${now.getFullYear()}`,
        issue:"Number not working",
        solution:"solved",
        billing: 'Auto Debit',
  ...
  export default {data,getDateRange}